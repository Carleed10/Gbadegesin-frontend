      ...
      <div className='relative bg-[rgb(248,248,248)] flex justify-center items-center w-full mt-[11vh] md:mt-[15vh] md:py-0 py-10  md:h-[85vh]'>
          <div className=''>
            <div className=' flex justify-center md:justify-between flex-wrap'>
              ...
              <div data-aos="zoom-in-down" data-aos-duration="2000" className='w-full md:w-[44%] flex flex-col justify-center items-center md:items-start pl-0 md:pl-[7%] text-center md:text-left'>
              ...
              <div  data-aos="fade-left" data-aos-duration="2000"  className='w-[85%] md:w-[56%]  md:h-[85vh] mt-[20px] md:mt-0'>
